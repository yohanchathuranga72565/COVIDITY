<div class="modal fade edit-profile" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" action="{{ route('admin.profileUpdate',Auth::user()->id)}}">
                @csrf
                {{-- @method('patch') --}}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="pno" type="text" class="form-control @error('pno') is-invalid @enderror" name="pno" value="{{Auth::user()->phone_number}}" required autocomplete="pno">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                        <input id="gender" type="text" class="form-control @error('gender') is-invalid @enderror" name="gender" value="{{Auth::user()->gender}}" readonly required autocomplete="pno">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="dob" type="text" class="form-control @error('dob') is-invalid @enderror" name="dob" value="{{Auth::user()->dob}}" required autocomplete="dob">
